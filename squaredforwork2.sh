#!/usr/bin/env bash
### Created by Peter Forret ( pforret ) on 2023-08-27
...
readonly script_created="2023-08-27"
...
function image2movie() {
  # $1 = input image
  # $2 = output image
  IO:log "image2movie [$1] [$2]"
  local input_image="$1"
  local output="$2"
  local input_short
